...
//  Question 2 with Single search term
...
val stopwordsRDD = sc.textFile("/FileStore/tables/common_english_words_with_contractions-3d1fd.txt")
...
val x1 = terms.cartesian(cleanLine)
...
val x2 = x1.map(a => ((a._1, a._2(0)), a._2))
x2.take(1)

// COMMAND ----------

// getting those documents where our search words have a Term Frequency and removing those where the term Frequency is 0
val tf = x2.map(l => (l._1, l._2.count(_.equals(l._1._1)).toDouble / l._2.size)).filter(c => c._2 != 0.0)
...
val nd = tf.map(a => (a._1._1, 1)).reduceByKey(_ + _)
...
val tfs = tf.map(a => ((a._1._1), (a._1._2, a._2)))
...
val tfidf = j.map(a => ((a._1, a._2._1._1), (a._2._1._2 * a._2._2)))
